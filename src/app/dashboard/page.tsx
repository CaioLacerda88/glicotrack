...
import { getGlucoseColorClass, getGlucoseLabel, getGlucoseStatus, formatDateTime, momentLabels } from '@/lib/utils'
...
export default async function DashboardPage() {
  ...
  return (
    <div>
        ...
        <Card>
          ...
          {lastInsulin ? (
            <>
              ...
              <p className="mt-1 text-xs text-gray-500">{formatDateTime(lastInsulin.taken_at)}</p>
            </>
          ) : (
      ...
      {/* Ações rápidas */}
      <div className="mt-6">
        <h2 className="mb-3 text-sm font-semibold text-gray-700">Ação rápida</h2>
